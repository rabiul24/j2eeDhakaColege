...
private String presentAdd;
  ...
  PreparedStatement ps = con.getConn().prepareStatement("update student  set name=?, father_name=?, Mather_name=?, dob=?, phone=?,"
          + " nId=?, religion=?, image=?, PresentAdd=?, address=?, gairdian_phone=?, media=?, year=?, seesion=? where id=7255;");
           ps.setString(1, name);
           ...
           ps.setString(10, adds);
           ps.setString(11, gdphn );
           ps.setString(12, media);
           ps.setString(13, year);
           ps.setString(14, ssessn);    
